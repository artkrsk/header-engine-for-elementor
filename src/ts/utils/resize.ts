 ...
 *
 * Kept as a class (unlike the rest of the engine's factory architecture) on purpose: this file is a
 * vendored subset of `@arts/utilities`, signatures matching the original so consuming code stays
 * unchanged — not this repo's own architecture to redesign.
 */
export class Resize {
