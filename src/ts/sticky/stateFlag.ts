 ...
 * in the orchestrator so side effects (attribute swaps, the internal sticking callback) sequence
 * exactly between the class write and the event, as consumers observe them.
 */
