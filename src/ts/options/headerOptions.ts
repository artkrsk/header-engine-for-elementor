import { defaultHeightObserverOptions, defaultStickyOptions } from '../constants'
import type {
  IHeaderOptions,
...
export const resolveSticky = (value: IHeaderOptions['sticky']): IResolvedStickyOptions | false =>
  value === false
    ...
    : {
        ...
        reveal: value?.reveal ?? defaultStickyOptions.reveal,
        until: value?.until,
        ...
        zones: value?.zones ?? defaultStickyOptions.zones
      }
