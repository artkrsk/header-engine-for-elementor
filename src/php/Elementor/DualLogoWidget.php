...
class DualLogoWidget extends Widget_Base {
	...
	public function get_title(): string {
		return esc_html__( 'Dual Site Logo', 'artem-semkin-header-engine-for-elementor' );
	}
	...
	private function register_content_controls( string $tab ): void {
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Site Identity', 'artem-semkin-header-engine-for-elementor' ),
				'tab'   => $tab,
			)
		);
		...
		$this->add_control(
			'primary_logo',
			array(
				'label' => esc_html__( 'Site Logo', 'artem-semkin-header-engine-for-elementor' ),
		...
		$this->add_control(
			...
			array(
				...
				'raw'  => $this->get_site_identity_cta( esc_html__( 'Change Site Logo', 'artem-semkin-header-engine-for-elementor' ) ),
			)
		);
		...
		$this->add_control(
			'secondary_logo',
			array(
				'label' => esc_html__( 'Secondary Site Logo', 'artem-semkin-header-engine-for-elementor' ),
				'type'  => $media_preview_type,
		...
		$this->add_control(
			...
			array(
				'type' => Controls_Manager::RAW_HTML,
				'raw'  => $this->get_site_identity_cta( esc_html__( 'Change Site Secondary Logo', 'artem-semkin-header-engine-for-elementor' ) ),
			)
		);
		...
		$this->add_control(
			'logo_link_type',
			array(
				'label'     => esc_html__( 'Logo Link', 'artem-semkin-header-engine-for-elementor' ),
				'separator' => 'before',
				'type'      => Controls_Manager::SELECT,
				'options'   => array(
					'home'   => esc_html__( 'Home URL', 'artem-semkin-header-engine-for-elementor' ),
					'custom' => esc_html__( 'Custom URL', 'artem-semkin-header-engine-for-elementor' ),
					'none'   => esc_html__( 'No Link', 'artem-semkin-header-engine-for-elementor' ),
				),
				'default'   => 'home',
			)
		);
		...
		$this->add_control(
			'logo_custom_link',
			array(
				'label'     => esc_html__( 'Custom URL', 'artem-semkin-header-engine-for-elementor' ),
	...
	private function register_style_controls( string $tab ): void {
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Typography & Colors', 'artem-semkin-header-engine-for-elementor' ),
				'tab'        => $tab,
				'conditions' => array(
					'relation' => 'or',
					'terms'    => array(
		...
		$this->add_control(
			...
			array(
				...
				'label'     => esc_html__( 'Site Title', 'artem-semkin-header-engine-for-elementor' ),
		...
		$this->add_control(
			'color_title_control',
			array(
				'label'     => esc_html__( 'Text Color', 'artem-semkin-header-engine-for-elementor' ),
		...
		$this->add_control(
			...
			array(
				'type'      => Controls_Manager::HEADING,
				'label'     => esc_html__( 'Site Tagline', 'artem-semkin-header-engine-for-elementor' ),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Spacing & Sizes', 'artem-semkin-header-engine-for-elementor' ),
				'tab'        => $tab,
				'conditions' => array(
					'relation' => 'or',
					'terms'    => array(
		...
		$this->add_responsive_control(
			'logo_max_height',
			array(
				'label'      => esc_html__( 'Logo Max Height', 'artem-semkin-header-engine-for-elementor' ),
		...
		$this->add_responsive_control(
			'gap_logo_text',
			array(
				'label'      => esc_html__( 'Gap Between Logo & Text', 'artem-semkin-header-engine-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px', 'em', 'rem', 'custom' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_responsive_control(
			'gap_title_tagline',
			array(
				'label'      => esc_html__( 'Gap Between Title and Tagline', 'artem-semkin-header-engine-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px', 'em', 'rem', 'custom' ),
				'range'      => array(
					'px' => array(
		...
		$this->start_controls_section(
			'border_section',
			array(
				'label'     => esc_html__( 'Border', 'artem-semkin-header-engine-for-elementor' ),
				'tab'       => $tab,
				'condition' => array( 'has_logo' => 'yes' ),
			)
		);
