...
class Plugin {
	...
	public function init_elementor(): void {
		...
		add_action( 'elementor/element/after_add_attributes', array( $markup, 'add_zone_attributes' ) );
		...
		add_action( 'elementor/element/container/section_layout/before_section_end', array( $controls, 'add_header_sticky_layout_controls' ) );
		add_action(
		...
		add_action( 'elementor/element/container/section_layout_container/after_section_end', array( $controls, 'add_header_zone_section_controls' ), 11 );
